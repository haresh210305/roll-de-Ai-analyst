...
with col1:
    st.markdown("""
        <div style="padding: 1rem 0;">
            <h1 style="color: white; font-size: 2.5rem; font-weight: 700; margin: 0; text-shadow: 1px 1px 3px rgba(0,0,0,0.2);">Roll'd AI Analyst</h1>
            <p style="color: rgba(255,255,255,0.9); font-size: 1.2rem; margin: 0.5rem 0 0; font-weight: 400;">Transform business questions into actionable insights</p>
        </div>
    """, unsafe_allow_html=True)

with col2:
    st.image("rollde1.png", width=150)
