    ...
    try:
        ...
        if "USE sales;" in sql_query:
            ...
            with conn.cursor() as cursor:
                ...
                cursor.execute(actual_query.strip())
...
def execute_visualization_code(python_code, data_df):
    ...
    try:
        ...
        namespace = {"pd": pd, "px": px, "go": go, "df": data_df, "fig": None}
    ...
    <div class="header">
        <div class="title-container">
            ...
            <div class="logo-container">
                <img src="logo rolde.webp" class="logo-img" alt="Roll'd Logo">
            </div>
        </div> 
    </div>
""", unsafe_allow_html=True)
...
with st.sidebar:
    ...
    # Only show if the required environment variables are set
    if all([os.getenv(key) for key in ["DATABRICKS_SERVER_HOSTNAME", "DATABRICKS_HTTP_PATH", "DATABRICKS_ACCESS_TOKEN"]]):
        try:
            ...
            if connection:
                ...
                # Don't close the connection here as it's cached
            else:
...
```"""
                    ...
                    if all([os.getenv(k) for k in ["DATABRICKS_SERVER_HOSTNAME", "DATABRICKS_HTTP_PATH", "DATABRICKS_ACCESS_TOKEN"]]):
                        try:
                            ...
                            if error:
                                ...
                                # Visualization
                                if query_type == "Data Visualization" and python_code:
                    ...
                    if st.session_state.get("table_analysis") or st.session_state.get("sql_query"):
                        ...
                        if query_type == "Data Visualization" and len(selected_tabs) > 2:
